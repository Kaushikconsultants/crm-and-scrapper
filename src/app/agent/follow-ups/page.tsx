  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-1">Leads that require your attention today or are past due.</p>
      </div>
                  ...
                  <tr key={lead.id} className={`hover:bg-[#1a1a1a] transition-colors ${isOverdue(lead.follow_up_date) ? 'bg-red-500/5' : ''}`}>
                    ...
                    <td className="px-6 py-4 text-right">
                       <button 
                         ...
                         className="bg-orange-600 hover:bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors"
                       >
                         Log Call
                       </button>
                    </td>
      ...
      {selectedLead && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-[#111] border border-gray-800 rounded-3xl p-6 w-full max-w-lg shadow-2xl relative">
            ...
            <h2 className="text-xl font-bold text-white mb-1">Log Follow-up: {selectedLead.name}</h2>
            ...
            <form onSubmit={handleLogCall} className="space-y-5">
              <div>
                <label className="block text-gray-400 text-sm mb-2 font-medium">Outcome</label>
                <select 
                  value={status} 
                  onChange={(e) => setStatus(e.target.value)}
                  className="w-full bg-[#1a1a1a] border border-gray-800 rounded-xl p-3 text-white focus:outline-none focus:border-orange-500"
                >
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-[#1a1a1a] border border-gray-800 rounded-xl p-3 text-white focus:outline-none focus:border-orange-500 resize-none"
                />
              </div>
              ...
              <button 
                ...
                className="w-full bg-orange-600 text-white hover:bg-orange-500 disabled:opacity-50 rounded-xl py-3.5 font-semibold transition-all flex justify-center items-center gap-2"
              >
