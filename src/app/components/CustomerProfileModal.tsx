  ...
  return (
    <div className="fixed inset-0 bg-white/85 flex items-center justify-center z-[100] p-4 backdrop-blur-md">
      <div className="bg-[#0f0f12] border border-gray-200 rounded-3xl w-full max-w-5xl shadow-2xl relative flex flex-col h-[90vh] max-h-[850px] overflow-hidden">
        ...
        {/* Header */}
        <div className="p-6 border-b border-gray-200 flex justify-between items-center bg-[#15151b] shrink-0">
           <div>
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-6 overflow-y-auto border-r border-gray-200 flex flex-col justify-between bg-[#111115]">
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <h3 className="text-base font-bold text-gray-700 border-b border-gray-200/50 pb-2 uppercase tracking-wider">Customer Profile Details</h3>
              
              <div>
                <label className="block text-gray-600 text-xs mb-1.5 font-medium">Business Lead Status</label>
                <select 
                  value={status} 
                  onChange={(e) => setStatus(e.target.value)}
                  className="w-full bg-[#1a1a24] border border-gray-200 rounded-xl p-2.5 text-sm text-gray-900 focus:outline-none focus:border-blue-500"
                >
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#1a1a24] border border-gray-200 rounded-xl p-2.5 text-sm text-gray-900 focus:outline-none focus:border-blue-500 font-mono" 
                  placeholder="e.g. 9876543210"
                />
              </div>

              <div>
                <label className="block text-gray-600 text-xs mb-1.5 font-medium">Website Address</label>
                <input 
                  type="text" 
                  value={website} 
              ...
              <div>
                <label className="block text-gray-600 text-xs mb-1.5 font-medium">Instagram Link</label>
                <input 
                  type="text" 
                  value={instagram} 
              ...
              <div>
                <label className="block text-gray-600 text-xs mb-1.5 font-medium">Facebook Link</label>
                <input 
                  type="text" 
                  value={facebook} 
              ...
              <div className="pt-2">
                <button 
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-gray-900 rounded-xl py-2.5 text-sm font-semibold transition-colors flex items-center justify-center gap-2"
                >
            ...
            <div className="mt-6 border-t border-gray-200/80 pt-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {lead.phone ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-1.5 py-3 px-2 rounded-xl bg-gray-200/20 border border-gray-200/50 text-gray-600 text-center cursor-not-allowed">
            ...
            {/* AI Insights Card */}
            <div className="mt-6 border-t border-gray-200/80 pt-4 space-y-3">
              ...
              {loadingInsights ? (
                ...
                <div className="text-xs text-gray-700 leading-relaxed bg-[#0a0a0d] p-3.5 rounded-xl border border-gray-850 max-h-[220px] overflow-y-auto pr-1.5 whitespace-pre-wrap font-sans">
                  {insights}
                </div>
              ) : (
            ...
            <div className="mt-6 border-t border-gray-200/80 pt-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-gray-900 rounded-xl py-3 text-sm font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 active:scale-95"
              >
                {generatingPdf ? (
                  <>
          ...
          <div className="w-full md:w-1/2 flex flex-col h-full bg-[#0a0a0d] overflow-hidden">
            ...
            <div className="flex-1 p-6 overflow-y-auto min-h-[250px]">
              <h3 className="text-base font-bold text-gray-700 border-b border-gray-200/50 pb-2 mb-4 uppercase tracking-wider">Conversation Log Timeline</h3>
                  ...
                  {logs.map((log) => (
                    <div key={log.id} className="relative group">
                      ...
                      <div className="bg-[#121217] border border-gray-850 p-3.5 rounded-xl space-y-1">
                        ...
                        <p className="text-sm text-gray-600 mt-2 whitespace-pre-wrap break-words">{log.notes || "No call notes."}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="p-6 border-t border-gray-850 bg-[#121217] shrink-0">
              <form onSubmit={handleAddLog} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-gray-600 text-[10px] mb-1 font-medium">Outcome</label>
                    <select 
                      value={newLogStatus} 
                      onChange={(e) => setNewLogStatus(e.target.value)}
                      className="w-full bg-[#1c1c24] border border-gray-200 rounded-lg p-2 text-xs text-gray-900 focus:outline-none focus:border-emerald-500"
                    >
                    ...
                    <div className="col-span-2 grid grid-cols-2 gap-2 mt-1">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full bg-[#1c1c24] border border-orange-500/40 rounded-lg p-2 text-xs text-gray-900 focus:outline-none cursor-pointer"
                        />
                      </div>
                      <div>
                        <label className="block text-orange-400 text-[10px] mb-1 font-medium flex items-center gap-1">
                ...
                <div>
                  <label className="block text-gray-600 text-[10px] mb-1 font-medium">Interaction Notes</label>
                  <textarea 
                    rows={2}
                    value={newLogNotes}
                    onChange={(e) => setNewLogNotes(e.target.value)}
                    placeholder="Enter call notes or next steps..."
                    className="w-full bg-[#1c1c24] border border-gray-200 rounded-lg p-2 text-xs text-gray-900 focus:outline-none focus:border-emerald-500 resize-none"
                  />
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-gray-900 rounded-xl py-2 text-xs font-semibold transition-colors flex justify-center items-center gap-1.5"
                >
